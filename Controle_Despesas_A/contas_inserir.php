        ...
        <form name="cadastro" method="post" action="">
            <table>
                <tr>
                    ...
                    <td><input type="text" name="lancamento" size="40" maxlength="40" required></td>
                </tr>
                <tr>
                    <td><label for="codigo_cliente">Codigo Cliente:</label></td>
                    <td><input type="text" name="codigo_cliente" size="30" maxlength="30" required></td>
                </tr>
                <tr>
                    <td><label for="data">Data:</label></td>
                    <td><input type="date" name="data" size="14" maxlength="14" required></td>
                </tr>
                <tr>
                    <td><label for="valor">Valor:</label></td>
                    <td><input type="number" name="valor" size="30" maxlength="30" required></td>
                </tr>
                <tr>
                    <td><label for="historico">Histórico:</label></td>
                    <td><input type="text" name="historico" size="15" maxlength="15" required></td>
                </tr>
                <tr>
