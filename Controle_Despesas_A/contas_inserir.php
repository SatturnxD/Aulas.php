...
<body>
    ...
    <div id="cadastro">
        ...
        <form name="cadastro" method="post" action="">
            <table>
                <tr>
                    ...
                    <td><input type="text" name="lancamento" size="40" maxlength="40" required>
                </tr>
                <tr>
                    <td><label for="codigo_cliente">Codigo Cliente:</label></td>
                    <td><input type="text" name="codigo_cliente" size="30" maxlength="30" required>
                </tr>
                <tr>
        ...
        if (isset($_POST["cadastrar"])) {
            ...
            $sql .= "VALUES (null, '$lancamento', '$codigo_cliente', '$data', '$valor', '$historico')";
